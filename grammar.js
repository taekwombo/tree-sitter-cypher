...
module.exports = grammar({
    ...
    rules: {
        ...
        projection_item: function ($) { return choice(seq($.expression, word('as'), $.variable), $.expression); },
        ...
        expression: function ($) { return choice($.or_expression, $.xor_expression, $.and_expression, $.not_expression, $.comparison_expression, $.addition_expression, $.multiplicative_expression, $.exponential_expression, $.unary_expression, $.string_list_null_operator_expression); },
        ...
        string_list_null_operator_expression: function ($) { return expression(9, seq($.property_or_labels_expression, repeat(choice($.string_operator_expression, $.list_operator_expression, $.null_operator_expression)))); },
        list_operator_expression: function ($) { return choice(seq(word('in'), $.property_or_labels_expression), seq('[', $.expression, ']'), seq('[', optional($.expression), '..', optional($.expression), ']')); },
        ...
        atom: function ($) { return prec.left(choice($.literal, $.parameter, $.case_expression, seq(word('count'), '(', '*', ')'), $.list_comprehension, $.pattern_comprehension, seq(word('all'), '(', $.filter_expression, ')'), seq(word('any'), '(', $.filter_expression, ')'), seq(word('none'), '(', $.filter_expression, ')'), seq(word('single'), '(', $.filter_expression, ')'), $.relationships_pattern, $.parenthesized_expression, $.function_invocation, $.variable)); },
        ...
        id_in_coll: function ($) { return seq($.variable, word('in'), $.expression); },
        ...
        function_name: function ($) { return choice(seq($.namespace, $.symbolic_name), word('exists')); },
        ...
        symbolic_name: function ($) { return choice($.unescaped_symbolic_name, $.escaped_symbolic_name, word('count'), word('filter'), word('extract'), word('any'), word('none'), word('single')); },
