...
module.exports = grammar({
    ...
    rules: {
        ...
        union: function ($) { return seq(word('union'), optional(seq($.sp, word('all'))), $.single_query); },
        ...
        match: function ($) { return seq(optional(seq(word('optional'), $.sp)), word('match'), $.pattern, optional($.where)); },
        unwind: function ($) { return seq(word('unwind'), $.expression, $.sp, word('as'), $.sp, $.variable); },
        merge: function ($) { return seq(word('merge'), $.pattern_part, repeat(seq($.sp, $.merge_action))); },
        merge_action: function ($) { return seq(word('on'), $.sp, choice(word('create'), word('match')), $.sp, $.set); },
        ...
        "delete": function ($) { return seq(optional(seq(word('detach'), $.sp)), word('delete'), $.expression, repeat(seq(',', $.expression))); },
        remove: function ($) { return seq(word('remove'), $.sp, $.remove_item, repeat(seq(',', $.remove_item))); },
        ...
        yield_item: function ($) { return seq(optional(seq($.procedure_result_field, $.sp, word('as'), $.sp)), $.variable); },
        "with": function ($) { return seq(word('with'), $.projection_body, optional($.where)); },
        "return": function ($) { return seq(word('return'), $.projection_body); },
        projection_body: function ($) { return seq(optional(word('distinct')), $.sp, $.projection_items, optional(seq($.sp, $.order)), optional(seq($.sp, $.skip)), optional(seq($.sp, $.limit))); },
        projection_items: function ($) { return choice(seq('*', repeat(seq(',', $.projection_item))), seq($.projection_item, repeat(seq(',', $.projection_item)))); },
        projection_item: function ($) { return choice(seq($.expression, $.sp, word('as'), $.sp, $.variable), $.expression); },
        order: function ($) { return seq(word('order'), $.sp, word('by'), $.sp, $.sort_item, repeat(seq(',', $.sort_item))); },
        skip: function ($) { return seq(word('skip'), $.sp, $.expression); },
        limit: function ($) { return seq(word('limit'), $.sp, $.expression); },
        sort_item: function ($) { return seq($.expression, optional(choice(word('asc'), word('ascending'), word('desc'), word('descending')))); },
        where: function ($) { return seq(word('where'), $.sp, $.expression); },
        ...
        or_expression: function ($) { return expression(0, seq($.expression, $.sp, word('or'), $.sp, $.expression)); },
        // TODO: should have 1 precedence.
        xor_expression: function ($) { return expression(0, seq($.expression, $.sp, word('xor'), $.sp, $.expression)); },
        and_expression: function ($) { return expression(2, seq($.expression, $.sp, word('and'), $.sp, $.expression)); },
        not_expression: function ($) { return expression(3, seq($.sp, word('not'), $.expression)); },
        ...
        string_list_null_operator_expression: function ($) { return expression(0, seq($.expression, repeat1(choice($.string_operator_expression, $.list_operator_expression, $.null_operator_expression)))); },
        ...
        string_operator_expression: function ($) { return prec.left(seq(choice(seq($.sp, word('starts'), $.sp, word('with')), seq($.sp, word('ends'), $.sp, word('with')), seq($.sp, word('contains'))), $.expression)); },
        null_operator_expression: function ($) { return seq($.sp, word('is'), optional(seq($.sp, word('not'))), $.sp, word('null')); },
        ...
        id_in_coll: function ($) { return seq($.variable, $.sp, word('in'), $.sp, $.expression); },
        ...
        explicit_procedure_invocation: function ($) { return seq($.procedure_name, '(', seq($.expression, repeat(seq(',', $.expression))), ')'); },
        ...
        sp: function ($) { return prec.right(repeat1(choice($.comment, $._whitespace_char))); },
